    ...
    <div className="min-h-screen bg-[#0A0A0B] flex items-center justify-center px-4 pt-16">
      <div className="w-full max-w-sm">
        <div className="bg-[#141415] border border-[#2A2A2D] rounded-2xl p-8">
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 h-[48px] bg-white rounded-xl text-sm text-[#1f1f1f] font-medium hover:bg-gray-100 transition-colors duration-200 mb-6 cursor-pointer"
          >
